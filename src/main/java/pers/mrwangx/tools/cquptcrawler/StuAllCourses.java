...
import pers.mrwangx.tools.cquptcrawler.entity.Course;
...
public class StuAllCourses {
    ...
    public StuAllCourses(URLConfig baseURL) {
        setBaseURL(baseURL);
    }
     ...
     * @description 设置课表
     */
    public void searchCourses(String sno) throws IOException {
        this.courses = new Course[schoolweeks][coursenums][weekdays];
        Document doc = Jsoup.connect(baseURL.getUrl() + URLConfig.COURSE).data("xh", sno).get();
    ...
    public URLConfig getBaseURL() {
        return baseURL;
    }

    public void setBaseURL(URLConfig baseURL) {
